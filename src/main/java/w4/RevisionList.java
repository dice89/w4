...
public class RevisionList extends ArrayList<Revision> {
	...
	public HashMap<String, ArrayList<Revision>> aggregateCommentsList() {
	...
	public HashMap<String,HashMap<String,ArrayList<Revision>>> aggregateCommentsOverTimeAndOrigin(){
		HashMap<String, ArrayList<Revision>> timely = this.aggregateCommentsList();
